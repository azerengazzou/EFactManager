        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ZoneConfig>().HasData(
                new ZoneConfig() { id = 1, zoneNumber = "1", zonelength = 2, startPosition = 1, description = "enregist. de type 10", zoneType = "n", RecordConfigId = 1, },
                 ...
                 new ZoneConfig() { id = 1000, zoneNumber = "6a", zonelength = 4, startPosition = 25, description = "0 - réservé", zoneType = "n", RecordConfigId = 1 },
                 new ZoneConfig() { id = 6, zoneNumber = "6b", zonelength = 4, startPosition = 29, description = "0 - réservé", zoneType = "n", RecordConfigId = 1 },
                 new ZoneConfig() { id = 7, zoneNumber = "7", zonelength = 3, startPosition = 33, description = "numero de l'envoi", zoneType = "n", RecordConfigId = 1 },
                 ...
                 new ZoneConfig() { id = 9, zoneNumber = "8b", zonelength = 1, startPosition = 48, description = "0 - réservé", zoneType = "n", RecordConfigId = 1 },
                 ...
                 new ZoneConfig() { id = 12, zoneNumber = "11", zonelength = 1, startPosition = 51, description = "0 - réservé", zoneType = "n", RecordConfigId = 1 },
                 new ZoneConfig() { id = 13, zoneNumber = "12", zonelength = 1, startPosition = 52, description = "0 - réservé", zoneType = "n", RecordConfigId = 1 },
                 ...
                 new ZoneConfig() { id = 17, zoneNumber = "16", zonelength = 1, startPosition = 80, description = "0 - réservé", zoneType = "n", RecordConfigId = 1 },
                 new ZoneConfig() { id = 18, zoneNumber = "17", zonelength = 4, startPosition = 81, description = "0 - réservé", zoneType = "n", RecordConfigId = 1 },
                 new ZoneConfig() { id = 19, zoneNumber = "18", zonelength = 3, startPosition = 85, description = "0 - réservé", zoneType = "n", RecordConfigId = 1 },
                 new ZoneConfig() { id = 20, zoneNumber = "19", zonelength = 12, startPosition = 88, description = "0 - réservé", zoneType = "n", RecordConfigId = 1 },
                 new ZoneConfig() { id = 21, zoneNumber = "20", zonelength = 7, startPosition = 100, description = "0 - réservé", zoneType = "n", RecordConfigId = 1 },
                 new ZoneConfig() { id = 22, zoneNumber = "21", zonelength = 1, startPosition = 107, description = "0 - réservé", zoneType = "n", RecordConfigId = 1 },
                 ...
                 new ZoneConfig() { id = 25, zoneNumber = "24", zonelength = 5, startPosition = 115, description = "0 - réservé", zoneType = "n", RecordConfigId = 1 },
                 ...
                 new ZoneConfig() { id = 30, zoneNumber = "29", zonelength = 2, startPosition = 163, description = "0 - réservé", zoneType = "n", RecordConfigId = 1 },
                 ...
                 new ZoneConfig() { id = 32, zoneNumber = "31", zonelength = 8, startPosition = 167, description = "bic - compte financier A ", zoneType = "n", RecordConfigId = 1 },
                  ...
                  new ZoneConfig() { id = 36, zoneNumber = "35 ", zonelength = 1, startPosition = 178, description = "0 - réservé", zoneType = "n", RecordConfigId = 1 },
                  ...
                  new ZoneConfig() { id = 42, zoneNumber = "42 ", zonelength = 6, startPosition = 213, description = "0 - réservé", zoneType = "n", RecordConfigId = 1 },
                  ...
                  new ZoneConfig() { id = 44, zoneNumber = "43b ", zonelength = 1, startPosition = 230, description = "0 - réservé ", zoneType = "n", RecordConfigId = 1 },
                  new ZoneConfig() { id= 130,zoneNumber = "44 ", zonelength = 4, startPosition = 231, description = "0 - réservé", zoneType = "n", RecordConfigId = 1 },
                  ...
                  new ZoneConfig() { id = 134, zoneNumber = "47b ", zonelength = 1, startPosition = 269, description = "0 - réservé", zoneType = "n", RecordConfigId = 1 },
                  ...
                  new ZoneConfig() { id = 55, zoneNumber = "55 ", zonelength = 8, startPosition = 321, description = "0 - réservé", zoneType = "n", RecordConfigId = 1 },
                  new ZoneConfig() { id = 56, zoneNumber = "56 ", zonelength = 4, startPosition = 329, description = "0 - réservé", zoneType = "n", RecordConfigId = 1 },
                  new ZoneConfig() { id = 57, zoneNumber = "57 ", zonelength = 4, startPosition = 333, description = "0 - réservé", zoneType = "n", RecordConfigId = 1 },
                  new ZoneConfig() { id = 58, zoneNumber = "58 ", zonelength = 4, startPosition = 337, description = "0 - réservé", zoneType = "n", RecordConfigId = 1 },
                  new ZoneConfig() { id = 59, zoneNumber = "59 ", zonelength = 6, startPosition = 341, description = "0 - réservé", zoneType = "n", RecordConfigId = 1 },
                      new ZoneConfig() { id = 60, zoneNumber = "98 ", zonelength = 2, startPosition = 347, description = "0 - réservé", zoneType = "n", RecordConfigId = 1 },
                      new ZoneConfig() { id = 61, zoneNumber = "99 ", zonelength = 2, startPosition = 349, description = "0 - réservé", zoneType = "n", RecordConfigId = 1 },
