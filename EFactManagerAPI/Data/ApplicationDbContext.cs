...
namespace EFactManagerAPI.Data
{
    public class ApplicationDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            new ZoneConfig() { id = 559, zoneNumber = "300", zonelength = 6, startPosition = 191, description = "Année et mois de facturation", zoneType = "n", RecordConfigId = 12 },
                 new ZoneConfig() { id = 560, zoneNumber = "3001", zonelength = 2, startPosition = 197, description = "Code erreur", zoneType = "n", RecordConfigId = 12 },
                 new ZoneConfig() { id = 561, zoneNumber = "301", zonelength = 3, startPosition = 199, description = "Numéro d’envois ", zoneType = "n", RecordConfigId = 12 },
                 new ZoneConfig() { id = 562, zoneNumber = "3011", zonelength = 2, startPosition = 202, description = "Code erreur", zoneType = "n", RecordConfigId = 12 },
                 new ZoneConfig() { id = 563, zoneNumber = "302", zonelength = 8, startPosition = 204, description = "Date de création de la facture", zoneType = "n", RecordConfigId = 12 },
                 new ZoneConfig() { id = 564, zoneNumber = "3021", zonelength = 2, startPosition = 212, description = "Code erreur", zoneType = "n", RecordConfigId = 12 },
                 new ZoneConfig() { id = 565, zoneNumber = "303", zonelength = 13, startPosition = 214, description = "Référence facture (not used pour les hôpitaux)", zoneType = "a-n", RecordConfigId = 12 },
                 new ZoneConfig() { id = 566, zoneNumber = "3031", zonelength = 2, startPosition = 227, description = "Code erreur", zoneType = "n", RecordConfigId = 12 },
                 new ZoneConfig() { id = 567, zoneNumber = "304", zonelength = 7, startPosition = 229, description = "numéro de version des instructions", zoneType = "n", RecordConfigId = 12 },
                 new ZoneConfig() { id = 568, zoneNumber = "3041", zonelength = 2, startPosition = 236, description = "Code erreur", zoneType = "n", RecordConfigId = 12 },
                 new ZoneConfig() { id = 569, zoneNumber = "305", zonelength = 45, startPosition = 238, description = "Nom de la personne de contact", zoneType = "n", RecordConfigId = 12 },
                 new ZoneConfig() { id = 570, zoneNumber = "3051", zonelength = 2, startPosition = 283, description = "Code erreur", zoneType = "n", RecordConfigId = 12 },
                 new ZoneConfig() { id = 571, zoneNumber = "306", zonelength = 24, startPosition = 285, description = "Prénom de la personne de contact", zoneType = "n", RecordConfigId = 12 },
                 new ZoneConfig() { id = 572, zoneNumber = "3061", zonelength = 2, startPosition = 309, description = "Code erreur( not used)", zoneType = "n", RecordConfigId = 12 },
                 new ZoneConfig() { id = 573, zoneNumber = "307", zonelength = 10, startPosition = 311, description = "Numéro de téléphone de la personne de contact", zoneType = "n", RecordConfigId = 12 },
                 new ZoneConfig() { id = 574, zoneNumber = "3071", zonelength = 2, startPosition = 321, description = "Code erreur", zoneType = "n", RecordConfigId = 12 },
                 new ZoneConfig() { id = 575, zoneNumber = "308", zonelength = 2, startPosition = 323, description = "Type de facture", zoneType = "n", RecordConfigId = 12 },
                 new ZoneConfig() { id = 576, zoneNumber = "3081", zonelength = 2, startPosition = 325, description = "Code erreur", zoneType = "n", RecordConfigId = 12 },
                 new ZoneConfig() { id = 577, zoneNumber = "309", zonelength = 2, startPosition = 327, description = "Type facturation", zoneType = "n", RecordConfigId = 12 },
                 new ZoneConfig() { id = 578, zoneNumber = "3091", zonelength = 2, startPosition = 329, description = "Code erreur", zoneType = "n", RecordConfigId = 12 },
                 new ZoneConfig() { id = 579, zoneNumber = "310", zonelength = 20, startPosition = 331, description = "Réserve", zoneType = "a-n", RecordConfigId = 12 },


                 //Les zones config pour message 920099

                  new ZoneConfig() { id = 580, zoneNumber = "1", zonelength = 2, startPosition = 1, description = "enregist. de type 10", zoneType = "n", RecordConfigId = 13, },
                 new ZoneConfig() { id = 581, zoneNumber = "2", zonelength = 6, startPosition = 3, description = "n° ordre enregist", zoneType = "n", RecordConfigId = 13 },
                 new ZoneConfig() { id = 582, zoneNumber = "3", zonelength = 1, startPosition = 9, description = "nombre numeros comptes financiers (code indice)", zoneType = "n", RecordConfigId = 13 },
                 new ZoneConfig() { id = 583, zoneNumber = "4", zonelength = 7, startPosition = 10, description = "version fichier", zoneType = "n", RecordConfigId = 13 },
                 new ZoneConfig() { id = 584, zoneNumber = "5", zonelength = 8, startPosition = 17, description = "n° compte financier a", zoneType = "n", RecordConfigId = 13 },

                 new ZoneConfig() { id = 1001, zoneNumber = "6a", zonelength = 4, startPosition = 25, description = "0 - réservé", zoneType = "n", RecordConfigId = 13 },
                 new ZoneConfig() { id = 585, zoneNumber = "6b", zonelength = 4, startPosition = 29, description = "0 - réservé", zoneType = "n", RecordConfigId = 13 },
                 new ZoneConfig() { id = 586, zoneNumber = "7", zonelength = 3, startPosition = 33, description = "numero de l'envoi", zoneType = "n", RecordConfigId = 13 },
                 new ZoneConfig() { id = 587, zoneNumber = "8a", zonelength = 12, startPosition = 36, description = "n° compte financier b ", zoneType = "n", RecordConfigId = 13 },
                 new ZoneConfig() { id = 588, zoneNumber = "8b", zonelength = 1, startPosition = 48, description = "0 - réservé", zoneType = "n", RecordConfigId = 13 },
                 new ZoneConfig() { id = 589, zoneNumber = "9", zonelength = 1, startPosition = 49, description = "code s.f.p ", zoneType = "n", RecordConfigId = 13 },
                 new ZoneConfig() { id = 590, zoneNumber = "10", zonelength = 1, startPosition = 50, description = "code fichier de decompte ", zoneType = "n", RecordConfigId = 13 },
                 new ZoneConfig() { id = 591, zoneNumber = "11", zonelength = 1, startPosition = 51, description = "0 - réservé", zoneType = "n", RecordConfigId = 13 },
                 new ZoneConfig() { id = 592, zoneNumber = "12", zonelength = 1, startPosition = 52, description = "0 - réservé", zoneType = "n", RecordConfigId = 13 },
                 new ZoneConfig() { id = 593, zoneNumber = "13", zonelength = 3, startPosition = 53, description = "contenu facturation ", zoneType = "n", RecordConfigId = 13 },
                 new ZoneConfig() { id = 594, zoneNumber = "14", zonelength = 12, startPosition = 56, description = "n° tiers payant 0", zoneType = "n", RecordConfigId = 13 },
                 new ZoneConfig() { id = 595, zoneNumber = "15", zonelength = 12, startPosition = 68, description = "n° accreditation cin ", zoneType = "n", RecordConfigId = 13 },
                 new ZoneConfig() { id = 596, zoneNumber = "16", zonelength = 1, startPosition = 80, description = "0 - réservé", zoneType = "n", RecordConfigId = 13 },
                 new ZoneConfig() { id = 597, zoneNumber = "17", zonelength = 4, startPosition = 81, description = "0 - réservé", zoneType = "n", RecordConfigId = 13 },
                 new ZoneConfig() { id = 598, zoneNumber = "18", zonelength = 3, startPosition = 85, description = "0 - réservé", zoneType = "n", RecordConfigId = 13 },
                 new ZoneConfig() { id = 599, zoneNumber = "19", zonelength = 12, startPosition = 88, description = "0 - réservé", zoneType = "n", RecordConfigId = 13},
                 new ZoneConfig() { id = 600, zoneNumber = "20", zonelength = 7, startPosition = 100, description = "0 - réservé", zoneType = "n", RecordConfigId = 13 },
                 new ZoneConfig() { id = 601, zoneNumber = "21", zonelength = 1, startPosition = 107, description = "0 - réservé", zoneType = "n", RecordConfigId = 13 },
                 new ZoneConfig() { id = 602, zoneNumber = "22", zonelength = 5, startPosition = 108, description = "annee facturee ", zoneType = "n", RecordConfigId = 13 },
                 new ZoneConfig() { id = 603, zoneNumber = "23", zonelength = 2, startPosition = 113, description = "mois facture ", zoneType = "n", RecordConfigId = 13 },
                 new ZoneConfig() { id = 604, zoneNumber = "24", zonelength = 5, startPosition = 115, description = "0 - réservé", zoneType = "n", RecordConfigId = 13 },
                 new ZoneConfig() { id = 605, zoneNumber = "25", zonelength = 7, startPosition = 120, description = "date de creation ", zoneType = "n", RecordConfigId = 13 },
                 new ZoneConfig() { id = 606, zoneNumber = "26", zonelength = 1, startPosition = 127, description = "date de creation ", zoneType = "n", RecordConfigId = 13 },
                 new ZoneConfig() { id = 607, zoneNumber = "27", zonelength = 10, startPosition = 128, description = "Numéro BCE ", zoneType = "n", RecordConfigId = 13 },
                 new ZoneConfig() { id = 608, zoneNumber = "28", zonelength = 25, startPosition = 138, description = "ref. etablissement ", zoneType = "n", RecordConfigId = 13 },
                 new ZoneConfig() { id = 609, zoneNumber = "29", zonelength = 2, startPosition = 163, description = "0 - réservé", zoneType = "n", RecordConfigId = 13 },
                 new ZoneConfig() { id = 610, zoneNumber = "30", zonelength = 2, startPosition = 165, description = "bic - compte financier A ", zoneType = "n", RecordConfigId = 13 },
                 new ZoneConfig() { id = 611, zoneNumber = "31", zonelength = 8, startPosition = 167, description = "bic - compte financier A ", zoneType = "n", RecordConfigId = 13 },
                  new ZoneConfig() { id = 612, zoneNumber = "32", zonelength = 1, startPosition = 175, description = "bic - compte financier A ", zoneType = "n", RecordConfigId = 13 },
                  new ZoneConfig() { id = 613, zoneNumber = "33 ", zonelength = 1, startPosition = 176, description = "bic - compte financier A ", zoneType = "n", RecordConfigId = 13 },
                  new ZoneConfig() { id = 614, zoneNumber = "34 ", zonelength = 1, startPosition = 177, description = "bic - compte financier A ", zoneType = "n", RecordConfigId = 13 },
                  new ZoneConfig() { id = 615, zoneNumber = "35 ", zonelength = 1, startPosition = 178, description = "0 - réservé", zoneType = "n", RecordConfigId = 13 },
                  new ZoneConfig() { id = 616, zoneNumber = "36 ", zonelength = 1, startPosition = 179, description = "iban - compte financier a  ", zoneType = "n", RecordConfigId = 13 },
                  new ZoneConfig() { id = 617, zoneNumber = "38 ", zonelength = 12, startPosition = 183, description = "iban - compte financier a  ", zoneType = "n", RecordConfigId = 13 },
                  new ZoneConfig() { id = 618, zoneNumber = "39 ", zonelength = 10, startPosition = 195, description = "iban - compte financier a ", zoneType = "n", RecordConfigId = 13 },
                  new ZoneConfig() { id = 619, zoneNumber = "40", zonelength = 2, startPosition = 205, description = "iban - compte financier a ", zoneType = "n", RecordConfigId = 13 },
                  new ZoneConfig() { id = 620, zoneNumber = "41 ", zonelength = 6, startPosition = 207, description = "iban - compte financier a  ", zoneType = "n", RecordConfigId = 13 },
                  new ZoneConfig() { id = 621, zoneNumber = "42 ", zonelength = 6, startPosition = 213, description = "0 - réservé", zoneType = "n", RecordConfigId = 13 },
                  new ZoneConfig() { id = 622, zoneNumber = "43a ", zonelength = 11, startPosition = 219, description = "bic - compte financier b  ", zoneType = "n", RecordConfigId = 13 },
                  new ZoneConfig() { id = 623, zoneNumber = "43b ", zonelength = 1, startPosition = 230, description = "0 - réservé ", zoneType = "n", RecordConfigId = 13 },
                  new ZoneConfig() { id = 624, zoneNumber = "44 ", zonelength = 4, startPosition = 231, description = "0 - réservé", zoneType = "n", RecordConfigId = 13 },
                  new ZoneConfig() { id = 625, zoneNumber = "45 ", zonelength = 26, startPosition = 235, description = "Réservé (réforme de l’état) ", zoneType = "n", RecordConfigId = 13 },
                  new ZoneConfig() { id = 626, zoneNumber = "46 ", zonelength = 1, startPosition = 261, description = "Réservé (réforme de l’état) ", zoneType = "n", RecordConfigId = 13 },
                  new ZoneConfig() { id = 627, zoneNumber = "47a ", zonelength = 7, startPosition = 262, description = "Réservé (réforme de l’état) ", zoneType = "n", RecordConfigId = 13 },
                  new ZoneConfig() { id = 628, zoneNumber = "47b ", zonelength = 1, startPosition = 269, description = "0 - réservé", zoneType = "n", RecordConfigId = 13 },
                  new ZoneConfig() { id = 629, zoneNumber = "48 ", zonelength = 1, startPosition = 270, description = "Réservé (réforme de l’état) ", zoneType = "n", RecordConfigId = 13 },
                  new ZoneConfig() { id = 630, zoneNumber = "49 ", zonelength = 12, startPosition = 271, description = "iban - compte financier b  ", zoneType = "n", RecordConfigId = 13 },
                  new ZoneConfig() { id = 631, zoneNumber = "50a ", zonelength = 3, startPosition = 283, description = "iban - compte financier b  ", zoneType = "n", RecordConfigId = 13 },
                  new ZoneConfig() { id = 632, zoneNumber = "50b ", zonelength = 1, startPosition = 286, description = "iban - compte financier b ", zoneType = "n", RecordConfigId = 13 },
                  new ZoneConfig() { id = 633, zoneNumber = "51 ", zonelength = 6, startPosition = 287, description = "iban - compte financier b ", zoneType = "n", RecordConfigId = 13 },
                  new ZoneConfig() { id = 634, zoneNumber = "52 ", zonelength = 12, startPosition = 293, description = "iban - compte financier b ", zoneType = "n", RecordConfigId = 13 },
                  new ZoneConfig() { id = 635, zoneNumber = "53 ", zonelength = 8, startPosition = 205, description = "Réservé (réforme de l’état) ", zoneType = "n", RecordConfigId = 13 },
                  new ZoneConfig() { id = 636, zoneNumber = "54a ", zonelength = 3, startPosition = 313, description = "Réservé (réforme de l’état) ", zoneType = "n", RecordConfigId = 13 },
                  new ZoneConfig() { id = 637, zoneNumber = "54b ", zonelength = 1, startPosition = 316, description = "-- ", zoneType = "n", RecordConfigId = 13 },
                  new ZoneConfig() { id = 638, zoneNumber = "54c ", zonelength = 4, startPosition = 317, description = "-- ", zoneType = "n", RecordConfigId = 13 },
                  new ZoneConfig() { id = 639, zoneNumber = "55 ", zonelength = 8, startPosition = 321, description = "0 - réservé", zoneType = "n", RecordConfigId = 13 },
                  new ZoneConfig() { id = 640, zoneNumber = "56 ", zonelength = 4, startPosition = 329, description = "0 - réservé", zoneType = "n", RecordConfigId = 13 },
                  new ZoneConfig() { id = 641, zoneNumber = "57 ", zonelength = 4, startPosition = 333, description = "0 - réservé", zoneType = "n", RecordConfigId = 13 },
                  new ZoneConfig() { id = 642, zoneNumber = "58 ", zonelength = 4, startPosition = 337, description = "0 - réservé", zoneType = "n", RecordConfigId = 13 },
                  new ZoneConfig() { id = 643, zoneNumber = "59 ", zonelength = 6, startPosition = 341, description = "0 - réservé", zoneType = "n", RecordConfigId = 13 },
                      new ZoneConfig() { id = 644, zoneNumber = "98 ", zonelength = 2, startPosition = 347, description = "0 - réservé", zoneType = "n", RecordConfigId = 13 },
                      new ZoneConfig() { id = 645, zoneNumber = "99 ", zonelength = 2, startPosition = 349, description = "0 - réservé", zoneType = "n", RecordConfigId = 13 },
                     
                      //Les zones d'erreur :
                      new ZoneConfig() { id = 646, zoneNumber = "100", zonelength = 3, startPosition = 351, description = "Identification d'envoi", zoneType = "n", RecordConfigId = 13 },
                      new ZoneConfig() { id = 647, zoneNumber = "101", zonelength = 8, startPosition = 354, description = "Date création - OA", zoneType = "n", RecordConfigId = 13 },
                      new ZoneConfig() { id = 648, zoneNumber = "102", zonelength = 6, startPosition = 362, description = "1", zoneType = "n", RecordConfigId = 13 },
                      new ZoneConfig() { id = 649, zoneNumber = "103", zonelength = 3, startPosition = 368, description = "1", zoneType = "n", RecordConfigId = 13 },
                      new ZoneConfig() { id = 650, zoneNumber = "104", zonelength = 12, startPosition = 371, description = "1", zoneType = "n", RecordConfigId = 13 },
                      new ZoneConfig() { id = 651, zoneNumber = "105", zonelength = 12, startPosition = 383, description = "1", zoneType = "n", RecordConfigId = 13 },
                      new ZoneConfig() { id = 652, zoneNumber = "106", zonelength = 12, startPosition = 395, description = "1", zoneType = "n", RecordConfigId = 13 },
                      new ZoneConfig() { id = 653, zoneNumber = "107", zonelength = 3, startPosition = 407, description = "1", zoneType = "n", RecordConfigId = 13 },
                      new ZoneConfig() { id = 654, zoneNumber = "108", zonelength = 3, startPosition = 410, description = "1", zoneType = "n", RecordConfigId = 13 },
                      new ZoneConfig() { id = 655, zoneNumber = "109", zonelength = 22, startPosition = 413, description = "1", zoneType = "n", RecordConfigId = 13 },
                      new ZoneConfig() { id = 656, zoneNumber = "110", zonelength = 22, startPosition = 435, description = "1", zoneType = "n", RecordConfigId = 13 },
                      new ZoneConfig() { id = 657, zoneNumber = "111a", zonelength = 1, startPosition = 457, description = "Lettre rejet 1", zoneType = "n", RecordConfigId = 13 },
                      new ZoneConfig() { id = 658, zoneNumber = "111b", zonelength = 6, startPosition = 458, description = "Code rejet 1", zoneType = "n", RecordConfigId = 13 },
                      new ZoneConfig() { id = 659, zoneNumber = "112a", zonelength = 1, startPosition = 464, description = "Lettre rejet 2", zoneType = "n", RecordConfigId = 13 },
                      new ZoneConfig() { id = 660, zoneNumber = "112b", zonelength = 6, startPosition = 465, description = "Code rejet 2", zoneType = "n", RecordConfigId = 13 },
                      new ZoneConfig() { id = 661, zoneNumber = "113a", zonelength = 1, startPosition = 471, description = "Lettre rejet 3", zoneType = "n", RecordConfigId = 13 },
                      new ZoneConfig() { id = 662, zoneNumber = "113b", zonelength = 6, startPosition = 472, description = "Code rejet 3", zoneType = "n", RecordConfigId = 13 },
                      new ZoneConfig() { id = 663, zoneNumber = "114", zonelength = 12, startPosition = 478, description = "1", zoneType = "n", RecordConfigId = 13 },
                      new ZoneConfig() { id = 664, zoneNumber = "115", zonelength = 12, startPosition = 490, description = "1", zoneType = "n", RecordConfigId = 13 },
                      new ZoneConfig() { id = 665, zoneNumber = "116", zonelength = 12, startPosition = 502, description = "1", zoneType = "n", RecordConfigId = 13 },
                      new ZoneConfig() { id = 666, zoneNumber = "117", zonelength = 7, startPosition = 514, description = "1", zoneType = "n", RecordConfigId = 13 },
                      new ZoneConfig() { id = 667, zoneNumber = "118", zonelength = 1, startPosition = 521, description = "1", zoneType = "n", RecordConfigId = 13 },
                      new ZoneConfig() { id = 668, zoneNumber = "119", zonelength = 12, startPosition = 522, description = "1", zoneType = "n", RecordConfigId = 13 },
                      new ZoneConfig() { id = 669, zoneNumber = "149", zonelength = 200, startPosition = 534, description = "1", zoneType = "n", RecordConfigId = 13 },
                      new ZoneConfig() { id = 670, zoneNumber = "150a", zonelength = 12, startPosition = 734, description = "1", zoneType = "n", RecordConfigId = 13 },
                      new ZoneConfig() { id = 671, zoneNumber = "150b", zonelength = 49, startPosition = 745, description = "1", zoneType = "n", RecordConfigId = 13 },
                      new ZoneConfig() { id = 672, zoneNumber = "151", zonelength = 6, startPosition = 795, description = "1", zoneType = "n", RecordConfigId = 13 }
